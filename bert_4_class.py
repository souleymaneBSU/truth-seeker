...
#5-label Classification (Commented out)
print("Training 5-label classification...")
train_5_label, test_5_label = prepare_datasets(train_data, test_data, "5_label_majority_answer", tokenizer)
final_accuracy_5_label = train_bert(train_5_label, test_5_label, num_labels=5)

# Final Output for 5-label
print(f"Final accuracy for 5-label classification: {final_accuracy_5_label}")
