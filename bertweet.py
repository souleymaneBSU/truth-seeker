...
# Tokenizer for BERTweet
tokenizer = AutoTokenizer.from_pretrained("vinai/bertweet-base", use_fast=True)

# 3-label Classification
print("Training 3-label classification with BERTweet...")
train_3_label, test_3_label = prepare_datasets(train_data, test_data, "3_label_majority_answer", tokenizer)
final_accuracy_3_label = train_bertweet(train_3_label, test_3_label, num_labels=3)
